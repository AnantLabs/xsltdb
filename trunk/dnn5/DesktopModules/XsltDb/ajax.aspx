...
*/
    ...
    private string Execute()
    {
        ...
        string res;
        Findy.XsltDb.XsltDbUtils.aConfig c = Findy.XsltDb.XsltDbUtils.GetConfig(ModuleID, TabID);
        string xsl = Findy.XsltDb.XsltDbUtils.GetXSLT(ModuleID, TabID);
        if (xsl.Trim().Length > 0)
            res = t.Transform(xml, xsl, c.IsSuper).Trim();
        else
