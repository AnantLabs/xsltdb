...
<asp:TextBox ID="txtXSLT" runat="server" TextMode="MultiLine"  Width="100%" Height="300px"></asp:TextBox>
...
<br />
<br />
<asp:LinkButton ID="linkPublish" runat="server" CssClass="CommandButton" oncommand="linkPublish_Command">Update &amp; Publish</asp:LinkButton>
&nbsp;|&nbsp;
<asp:LinkButton ID="linkUpdate" runat="server" oncommand="linkUpdate_Command" CssClass="CommandButton">Update</asp:LinkButton>
&nbsp;
<asp:LinkButton ID="linkCancel" runat="server" oncommand="linkCancel_Command" CssClass="CommandButton">Cancel</asp:LinkButton>
&nbsp;|&nbsp;
<asp:LinkButton ID="linkPublishAll" runat="server" CssClass="CommandButton" oncommand="linkPublishAll_Command">Publish All</asp:LinkButton>
&nbsp;|&nbsp;
